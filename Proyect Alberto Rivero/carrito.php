                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="product-name">
                            <h2 class="info-card"><?php echo $arregloCarrito[$i]['Nombre']; ?></h2>
                        </td>
                        <td class="precio__carrito">
                            <h2 class="precio__car"><?php echo $arregloCarrito[$i]['Precio'] ?>€</h2>
                        </td>
                        <td>
                        ...
                        <td>
                            <h2 class="total__carrito<?php echo $arregloCarrito[$i]['Id']; ?>"><?php echo $arregloCarrito[$i]['Precio'] * $arregloCarrito[$i]['Cantidad'];?>€</h2>
                        </td>
                        <td><a href="#" class="btnBorrar" data-id="<?php echo $arregloCarrito[$i]['Id'];?>">X</a></td>
                    </tr>
                    <?php } } ?>
                </tbody>
            </table>
